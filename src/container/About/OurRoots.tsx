        ...
        <Grid item xs={12} md={4}>
          <Stack direction="column">
            ...
            <p style={{ textAlign: "justify" }}>
              ...
              internet and society as a whole. But to get there, we need
              leaders, thinkers and builders like never before. In short, we
              need you. Let’s break the cycle of inequality, together. Here’s
              how we’ll support you to bring the change we need in Web3.
            </p>
          </Stack>{" "}
        </Grid>
